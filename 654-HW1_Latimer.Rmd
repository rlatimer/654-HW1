...
```{r 1.5,eval=TRUE,echo=FALSE}
load("/home/latimer/hw1/hw1b.RData")
```
...
blueprint <- recipe(x  = clean_tweet,
                    vars  = c(numeric,categorical,harmonic, outcome),
...
blueprint2 <- recipe(x  = ORtest,
                    vars  = c(categorical,cyclic,numeric,outcome,id),
